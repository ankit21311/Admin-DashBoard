...
export default function SignIn() {
    ...
    const handleDemoSignIn = async (demoType: 'admin' | 'user') => {
      ...
      try {
          ...
          toast.error(`Demo ${demoType} account not found. Please create the account first.`);
      } finally {
          setIsLoading(false);
      }
  };
        ...
        <div
          ...
          <Card>
              <CardHeader>
                  ...
                  <CardDescription>
                      Use Firebase authentication to access the dashboard
                  </CardDescription>
              </CardHeader>
              ...
              <div className="space-y-2">
                  ...
                  <div className="text-xs text-center text-muted-foreground">
                      ...
                      <p className="mt-1 text-orange-600 dark:text-orange-400">
                          Note: Create these accounts first if they don't exist
                      </p>
                  </div>
              </div>
          </CardContent>
